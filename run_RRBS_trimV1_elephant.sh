...
CHROM_SIZES="/data/reference_genomes/xenarthra/elephant/data/GCF_030014295.1/GCF_030014295.1_mLoxAfr1.hap2_genomic.sizes"
...
trimReads 1
run_fastQC
alignBismark /data/reference_genomes/xenarthra/elephant/data/GCF_030014295.1
collectBismarkStats
